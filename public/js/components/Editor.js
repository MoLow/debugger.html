...
const Editor = React.createClass({
  ...
  highlightLine() {
    ...
    if (this.pendingJumpLine) {
      ...
      if(this.curHighlightLine) {
        codeMirror.removeLineClass(this.curHighlightLine - 1, "line", "highlight-line");
      }
  ...
  componentDidUpdate(prevProps) {
    ...
    // loaded.
    if(isTextForSource(this.props.sourceText)) {
